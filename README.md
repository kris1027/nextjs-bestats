...
tabs. The ranking is TMDB's, not ours. Every page of cards ends in a legend
for what a card can wear: TMDB's rating, your Score, a Planned bookmark, and
on the lists the next Episode or the day it is out.
...
components/
  media/                 Card, list, legend, detail, placeholder artwork
