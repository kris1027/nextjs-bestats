 ...
 * back to. Composed here once so the three things that send someone there —
 * the header's link, the marking action and the lists — agree on the
 * spelling `nextPath` reads back.
 */
